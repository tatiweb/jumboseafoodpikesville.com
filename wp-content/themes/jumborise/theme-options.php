...
require_once (OPTIONS_FRAMEWORK_DIRECTORY . 'meta-box-class/meta-box-slider.php');
require_once (OPTIONS_FRAMEWORK_DIRECTORY . 'meta-box-class/meta-box-menu-item.php');
}
