...
public function supernova_admin_styles() {
        global $wp_version;
                    wp_register_style( 'custom_wp_admin_css', SUPERNOVA_ROOT_ADMIN.'css/admin-css.css', array(), '1.5.0', 'all' );
                    wp_register_style( 'supernova_all_css', SUPERNOVA_ROOT_ADMIN.'css/all.css', array(), '1.5.0', 'all' );
                    wp_register_style( 'supernova_older_css', SUPERNOVA_ROOT_ADMIN.'css/old/older.css', array(), '1.5.0', 'all' );
                    wp_register_style( 'supernova_select2', SUPERNOVA_ROOT_ADMIN.'css/select2.css', array(), '1.5.0', 'all' );
...
public function supernova_admin_scripts() {
         if (isset($_GET['page']) && $_GET['page'] == 'theme-options'){
            ...
            wp_register_script( 'select2_script', SUPERNOVA_ROOT_ADMIN.'js/select2.js', array('jquery'),'1.5.0', false );
            wp_register_script( 'my_custom_script', SUPERNOVA_ROOT_ADMIN.'js/adminjs.js', array('jquery'),'1.5.0', false );
            wp_register_script( 'jquery_ui_plugin', SUPERNOVA_ROOT_ADMIN.'js/jquery-ui-slider.js', array('jquery'),'1.5.0', false );
