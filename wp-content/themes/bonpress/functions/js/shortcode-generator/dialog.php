...
$wpz_shortcode_css = $wpz_framework_path . 'css/shortcodes.css';
...
<script type="text/javascript" src="<?php echo $wpz_framework_url; ?>js/shortcode-generator/js/column-control.js"></script>
<script type="text/javascript" src="<?php echo $wpz_framework_url; ?>js/shortcode-generator/js/tab-control.js"></script>
<?php  }  else { ?>
...
<script type="text/javascript" src="<?php echo $wpz_framework_url; ?>js/shortcode-generator/js/dialog-js.php"></script>
